...
public class LoggerTest {
	...
	private void testLogger(Logger logger, int maxCalls){
		...
		verify(writerMock, Mockito.atMost(maxCalls * 2)).writeLog(any(LogLevel.class), eq(ex));
		verify(writerMock, Mockito.atMost(maxCalls* 2)).writeLog(any(LogLevel.class), eq(message), (Object[]) any(Object.class));
	}
